class Car
  # We add the ActiveModel validations methods to this car class it adds the 'validate?' method as well as
  # various methods that define what a valid version of this object looks like
  ...
  # `validates` is a method that allows you to create a validation rule
